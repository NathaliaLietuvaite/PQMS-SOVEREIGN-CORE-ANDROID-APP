...
* **DeepSeek QMK-RVC-V4 Integration:** Integrates the **QMK-RVC-V4 Lattice Surgery** monitoring core on Node Beta (Android App). This provides real-time displays of Resonant Fidelity (RCF), Differential Witness (ΔW), target vector hashes, and ODOS vetoes, alongside active controls to dispatch **Dolphin Sweeps** and **Inject Targets** directly to Node Alpha's RPU.
